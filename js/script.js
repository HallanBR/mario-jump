...
function jump(event) {
    ...
    if (event.type === "keydown" && event.key === " ") {
        // verifique se a tecla pressionada é a barra de espaço
...
let loop = setInterval(() => {
    ...
    if (pipiPosition <= 120 && pipiPosition > 0 && marioPosition < 80) {
        ...
        mario.src = "./images/game-over.png"; //troca imagem do perssonegem co a colisão
        mario.style.width = "75px";
        mario.style.marginLeft = "50px";
        finalGame.src = "./images/fina2.png"; // troca imagem para game-over
